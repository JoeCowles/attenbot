  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 w-full">
      ...
      <main>
        ...
        <div className="w-full bg-gray-100 mt-12 md:mt-0">
            ...
            >
              ...
              >
                <input
                  ...
                  className="flex-grow px-4 py-2 rounded-md border border-gray-300 bg-white focus:outline-none focus:ring-2 focus:ring-[#0c8cfc]"
                />
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <p className="mt-2 text-sm text-gray-600">&copy; {new Date().getFullYear()} Attenbot. All rights reserved.</p>
            </div>
            <div className="flex space-x-4">
              <a href="#contact" className="text-gray-600 hover:text-[#0c8cfc]">Contact</a>
            </div>
          </div>
        </div>
      </footer>
